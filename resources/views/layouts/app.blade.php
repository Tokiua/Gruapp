...
<head>
    ...
    <title>{{ config('app.name', 'GruApp') }}</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        @guest
                            ...
                            @endif
                        @else
                        <a href="{{ route('informacion.usuario') }}">
                            <img src="{{ asset('imagenes/informacion.png') }}" alt="Icono de usuario" style="width: 45px; height: auto;">
                        </a>
